...
function sum(a, b) { //eslint-disable-line
  var result = [];
  var add= a + b;
  var message = 'The sum of ' + a + ' and ' + b + ' is ' + add+ '.';
  result.push(add);
  result.push(message);
  return result;
}
...
his function by hand in the console to get it working, and when you think it is finished, uncomment the call for the testSumAndMultiply() function and see if the test passes.*/
